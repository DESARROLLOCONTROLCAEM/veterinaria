                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div class="font-weight-bold">
                                        <div class="text-truncate">Aprovecha Nuestras Promociones</div>
                                        <div class="small text-gray-500">Angel Pets · 58m</div>
                                    </div>
                                </a>
                            </div>
                        </li>
                ...
                <div class="container-fluid">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Costo de Eutanasia</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">$182,000</div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div style="width:1200px; margin:0 auto;">
                        <div class="sidebar-card d-none d-lg-flex">
                            <img class="sidebar-card-illustration mb-2" src="images/Screenshot_3.png" alt="...">
                        </div>
                    </div>
                    <!-- Content Row -->
                    <div class="container">

                        <div class="card o-hidden border-35 shadow-lg my-35">
                    ...
                    <div class="container">
                        ...
                        <div class="card o-hidden border-0 shadow-lg my-5">
                            <div class="card-body p-0">
                                ...
                                <div class="row">
                                    <div class="col-lg-5 d-none d-lg-block ">
                                        <img class="sidebar-card-illustration mb-2" src="images/about-02.jpg" alt="...">
                                    </div>
                                    <div class="col-lg-7">
                                        <div class="p-5">
                                            <div class="text-center">
                                                <h1 class="h4 text-gray-900 mb-4">Contactanos!</h1>
                                            </div>
                                            <form class="user">
                                                ...
                                                <div class="form-group">
                                                    <textarea id="my-textarea" placeholder="comentario" class="form-control" name="" rows="3"></textarea>
                                                </div>
